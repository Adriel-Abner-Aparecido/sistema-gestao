...
export const RelatorioVendasVendedor = () => {
    ...
    const gerarRelatorio = () => {
        ...
        if (dataInicio != "" && dataFinal != "") {
            ...
            if (checkDates(dataInicio, dataFinal)) {
                get(process.env.NEXT_PUBLIC_API_URL + '/vendasbyvendedor/periodo/' + dataInicio + '/' + dataFinal + '').then((res) => {
                    if (res.mensagem) {
                        ...
                        let totalValor = res.reduce((total, item) => total + item.venda_total, 0)
