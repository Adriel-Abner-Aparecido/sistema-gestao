...
export const UnidadeModal = (props) => {
    ...
    const salvar = () => {
        ...
        let sigla = document.getElementById('siglaUnidade').value;
        ...
        post(process.env.NEXT_PUBLIC_API_URL + '/unidades', data).then((res) => {
            if (res.mensagem) {
                ...
                <div className="relative rounded-lg shadow bg-gray-600">
                    ...
                    <div className="p-6 space-y-6">
                        <div>
                            ...
                            <input id='nomeUnidade' className="border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-500 border-gray-400 placeholder-gray-300 text-white" required />
                        </div>
                        <div>
                            <label className="block mb-2 text-sm font-medium text-gray-300">Sigla</label>
                            <input id='siglaUnidade' className="border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-500 border-gray-400 placeholder-gray-300 text-white" required />
                        </div>
                    </div>
                    {/*<!-- Modal footer --> */}
                    {loading ? (
