...
const PaymentPendingPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <Head>
        <title>APPLoja Web | Pagamento Pendente</title>
      ...
      >
        ...
        >
          <FaRegSmileWink className="text-6xl text-yellow-500 mb-4" />
        </motion.div>
        <motion.h1
        ...
        >
          Pagamento via PIX pode levar até 30 minutos para cair no nosso sistema
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
