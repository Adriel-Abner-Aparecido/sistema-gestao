...
export const NewXmlImporter = (props) => {
    ...
    const salvarEntrada = async (event) => {
        ...
        const dataEntrada = {
            ...
            duplicatas: parcelas.map((parcela) => ({
                vendaId: null,
                fornecedorId: '',
                valor: parcela.valor,
            ...
            produtos: produtos.map((produto, i) => ({
                ...
                listaPrecoId: 1,
                valor: variacaoPreco[i].valor,
                markup: variacaoPreco[i].markup,
                valorCusto: variacaoPreco[i].valorCusto,
                ...
                valorTotal: parseFloat(variacaoPreco[i].valorCusto) * Number(estoque[i].quantidade) || 0
            })),
                ...
                <div className="relative p-4 w-4/5 h-full sm:h-auto">
                    <div className="relative rounded-lg shadow bg-gray-300">
                                ...
                                <div className="w-full flex flex-col gap-4 border-b border-slate-500 pb-4">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-4 flex-wrap">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-4 md:items-center">
                                            ...
                                            <input className="p-1 focus:outline-none" type="text" name="tipopag" id="tipopag" value={dadosNf.tipopag} size={20} />
                                        </div>
                                    </div>
                                </div>
                                <div className="w-full flex flex-col gap-4 border-b border-slate-500 pb-4">
                                ...
                                <div className="w-full flex flex-col gap-4 border-b border-slate-500 pb-4">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-4 flex-wrap">
                                        <div className="flex flex-col md:flex-row gap-4 md:items-center">
                                            ...
                                            <input className="p-1 focus:outline-none" type="text" name="cnpjtransp" id="cnpjtransp" value={dadosTransporte.cnpjtransp} size={20} />
                                        </div>
                                        <div className="flex flex-col md:flex-row gap-4 md:items-center">
                                            <label htmlFor="nometransp">Razão Social:</label>
                                            <input className="p-1 focus:outline-none" type="text" name="nometransp" id="nometransp" value={dadosTransporte.nometransp} size={35} />
                                        </div>
                                        <div className="flex flex-col md:flex-row gap-4 md:items-center">
                                            <label htmlFor="valorfrete">Valor:</label>
                                            <input className="p-1 focus:outline-none text-right" type="number" name="valorfrete" id="valorfrete" value={dadosTransporte.valorfrete} size={8} />
                                        </div>
                                    </div>
                                </div>
                                <div className="w-full flex flex-col gap-4 border-b border-slate-500 pb-4">
                                            ...
                                            <tbody className="py-2">
                                                {
                                                    produtos.map((item, i) => (
                                                        <tr key={i}>
                                                            ...
                                                            <td>
                                                                <input className="p-1 focus:outline-none text-right w-full" type="number" value={variacaoPreco[i].valorCusto && estoque[i].quantidade ? parseFloat(variacaoPreco[i].valorCusto) * Number(estoque[i].quantidade) : ""} readOnly size={4} />
                                                            </td>
                        ...
                        <div className="flex items-center justify-between p-6 space-x-2 rounded-b">
                            {
                                loading ? <>
                                    <button type="reset" form="formEntrada" className="focus:ring-4 focus:outline-none rounded-lg border text-sm font-medium px-5 py-2.5 focus:z-10 bg-red-700 text-white border-red-500 hover:text-white hover:bg-red-600 focus:ring-red-600">Aguarde...</button>
                                    <button type="button" className="text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-green-600 hover:bg-green-700 focus:ring-green-800">Aguarde...</button>
                                </> : <>
                                    <button onClick={() => setPopUpConfirmacao(true)} type="reset" form="formEntrada" className="focus:ring-4 focus:outline-none rounded-lg border text-sm font-medium px-5 py-2.5 focus:z-10 bg-red-700 text-white border-red-500 hover:text-white hover:bg-red-600 focus:ring-red-600">Excluir</button>
                                    {
                                        !entrada.id && <button form="formEntrada" type="submit" className="text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-green-600 hover:bg-green-700 focus:ring-green-800">Salvar</button>
                                    }
                                </>
                ...
                loading ?
                    <div className={popUpConfirmacao ? "fixed inset-0 flex h-full items-center justify-center bg-gray-700 bg-opacity-60" : "hidden"}>
                        <div className="bg-gray-200 p-6 rounded-lg shadow-lg max-w-sm w-full flex flex-col gap-2">
                            ...
                            <div className="flex flex-row gap-4">
                                <button className="flex-1 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Aguarde...</button>
                                <button className="flex-1 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Aguarde</button>
                            </div>
                        </div>
                    </div>
                    :
                    <div className={popUpConfirmacao ? "fixed inset-0 flex h-full items-center justify-center bg-gray-700 bg-opacity-60" : "hidden"}>
                        <div className="bg-gray-200 p-6 rounded-lg shadow-lg max-w-sm w-full flex flex-col gap-2">
                            <h1 className="text-2xl text-gray-700 text-center">Tem certeza ?</h1>
                            <div className="flex flex-row gap-4">
                                <button onClick={deleteEntrada} className="flex-1 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Sim</button>
