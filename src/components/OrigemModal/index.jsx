...
export const OrigemModal = (props) => {
    ...
    const salvar = () => {
        ...
        let nome = document.getElementById('nomeOrigem').value;
        let origem = document.getElementById('numeroOrigem').value;
        ...
        post(process.env.NEXT_PUBLIC_API_URL + '/origens', data).then((res) => {
            if (res.mensagem) {
            ...
            <div className="relative p-4 w-full h-full sm:h-auto">
                ...
                <div className="relative rounded-lg shadow bg-gray-200">
                    ...
                    <div className="p-6 space-y-6">
                        <div>
                            <label className="block mb-2 text-sm font-medium text-gray-300">Origem</label>
                            <input id='numeroOrigem' className="border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-500 border-gray-400 placeholder-gray-300 text-white" required />
                        </div>
                        <div>
                            <label className="block mb-2 text-sm font-medium text-gray-300">Descrição</label>
                            <input id='nomeOrigem' className="border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-500 border-gray-400 placeholder-gray-300 text-white" required />
                        </div>
                    </div>
                    {/*<!-- Modal footer --> */}
                    {loading ? (
