...
export const TamanhoModal = (props) => {
    ...
    const salvar = () => {
        ...
        let nome = document.getElementById('nomeTamanho').value;
        ...
        post(process.env.NEXT_PUBLIC_API_URL + '/tamanhos', data).then((res) => {
            if (res.mensagem) {
                ...
                if (res.message == undefined) {
                    ...
                    closeModal();
                    document.getElementById('nomeTamanho').value = '';
    ...
    const deletar = () => {
        ...
        remove(process.env.NEXT_PUBLIC_API_URL + '/tamanhos/' + idCor + '').then((res) => {
            if (res.mensagem) {
                if (res.mensagem == "falha na autenticação") {
                    console.log('falha na autenticação');
                ...
                <div className="relative rounded-lg shadow bg-gray-200">
                    ...
                    <div className="p-6 space-y-6">
                        <div>
                            ...
                            <input id='nomeTamanho' className="border text-sm rounded-lg block w-full p-2.5" required />
                        </div>
                    </div>
                    {/*<!-- Modal footer --> */}
                    {loading ? (
